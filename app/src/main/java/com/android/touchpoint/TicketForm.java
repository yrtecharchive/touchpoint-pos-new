...
//                    Show my user need
    ...
    private void setResult(String contents){
        ...
        if (qrCode.isEmpty()) {
            Toast.makeText(TicketForm.this, "Please enter a QR code", Toast.LENGTH_SHORT).show();
            return;
        }

        String url = "http://10.0.0.130/parkingci/handheld/terminalBillRequest?access=QR&code=" + qrCode;

        // Send data using BillRequest
        new BillRequest(result -> {
            if (result instanceof String) {
                Toast.makeText(TicketForm.this, "Response: " + result, Toast.LENGTH_LONG).show();
                ...
                Intent intent = new Intent(TicketForm.this, BillDetailsActivity.class);
